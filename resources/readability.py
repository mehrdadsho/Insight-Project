...
from resources.readability_utils import get_char_count
from resources.readability_utils import get_words
from resources.readability_utils import get_sentences
from resources.readability_utils import count_syllables
from resources.readability_utils import count_complex_words
...
if __name__ == "__main__":
    test_text = """We are close to wrapping up our 10 week Rails Course. This week we will cover a handful of topics 
    ...
    as you can, but also making sure you have the tools to succeed after the class is over. """

    rd = Readability(test_text)
    print('Test text:')
    print('"%s"\n' % test_text)
    print('ARI: ', rd.ARI())
